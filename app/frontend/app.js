...
const I18N = {
  fr: {
    ...
    sub_verify: 'Porte 1 — Mode manuel · même moteur que l’API', sub_disputes: 'KODA assemble les preuves — vous décidez',
    ...
    dsp_claim: 'Réclamation / motif du client', dsp_open: 'Ouvrir un litige (3 ACU)', dsp_accept: 'Accepter', dsp_reject: 'Refuser', dsp_escalate: 'Escalader à KODA', dsp_none: 'Aucun litige — c\'est l\'objectif.', acc_add: 'Ajouter un compte de réception', acc_add_p: 'Saisissez l\'opérateur + le numéro/caisse où paient les clients. Nous vous donnons une référence unique ; faites un petit paiement test qui la porte, et dès que votre Sentinel le capte, le compte est vérifié.', acc_connect: 'Connecter le compte', acc_op_ph: 'Code opérateur (ex. orange_cd)', acc_op_pick: 'Choisir un opérateur…', th_action: 'Action', acc_verified: 'Propriété vérifiée', acc_on: 'Activé', acc_off: 'Désactivé', acc_edit: 'Modifier', acc_remove: 'Supprimer', acc_edit_num: 'Numéro/caisse de réception :', acc_edit_holder: 'Nom du titulaire :', saved: 'Enregistré', acc_del_confirm: 'Supprimer ce moyen de paiement ?', acc_removed: 'Supprimé', acc_at_checkout: 'Affiché au paiement', acc_none_live2: 'Activez un moyen de paiement ci-dessus pour l\'afficher aux clients.', acc_sentinel_on: 'Un Sentinel KODA est en ligne — les paiements se vérifient automatiquement et en toute sécurité (configuration recommandée).', acc_sentinel_off: 'Recommandé : installez l\'app KODA Sentinel sur le téléphone qui reçoit l\'argent — elle lit le vrai SMS de l\'opérateur et vérifie chaque paiement automatiquement, avec protection anti-fraude automatique. Pas d\'app pour l\'instant ? Vous pouvez confirmer chaque paiement en collant le SMS de l\'opérateur reçu.', acc_paste_cta: 'Confirmer en collant le SMS', acc_num_ph: 'Votre numéro/caisse de paiement', acc_holder_ph: 'Nom du titulaire du compte', acc_yours: 'Vos comptes', acc_none: 'Aucun compte pour l\'instant. Connectez-en un ci-dessus.', acc_would_see: 'Ce que verraient les clients maintenant', acc_no_live: 'Aucun moyen de paiement actif — connectez et activez un compte (et gardez un Sentinel en ligne pour les portes auto).', th_operator: 'Opérateur', th_number: 'Numéro', th_ownership: 'Propriété', th_status: 'Statut', th_doors: 'Portes', dev_label_ph: 'Étiquette — ex. Caisse 2', dev_get_app: 'Obtenir l\'app Sentinel ↗', dev_none: 'Aucun appareil pour l\'instant.', dev_capture: 'capture', dev_cap_sms: 'SMS (version hors-Play)', dev_cap_notif: 'Notifications (version Play)', dev_notif_tip: 'Gardez les notifications de paiement de l\'opérateur ACTIVÉES sur ce téléphone — cette version vérifie à partir de la notification, pas du SMS. Si les notifications sont coupées, les paiements ne seront pas captés.', dev_builds_note: 'Sentinel existe en deux versions : l\'app hors-Play lit le SMS de l\'opérateur ; l\'app Google Play lit la notification de paiement (sans permission SMS). Chaque téléphone affiche son mode ci-dessous.', tm_name_ph: 'Nom', tm_email_ph: 'E-mail', th_name: 'Nom', th_email: 'E-mail', th_role: 'Rôle', tm_audit: 'Piste d\'audit', tm_empty: 'Vide', bl_burned: 'ACU consommés · 30 jours', bl_topup_suffix: 'prépayé via mobile money, vérifié par KODA elle-même', bl_voucher_p: 'Vous avez acheté un bon KODA chez un revendeur ? Entrez le PIN pour créditer les ACU instantanément.', bl_distributor: 'Distributeur ?', bl_distributor_p: 'Si KODA vous a configuré comme distributeur (revendeur d\'ACU), gérez votre float et vos ventes ici.', bl_see_all: 'Voir toutes les formules et fonctions →', bl_acu_tx: 'Transactions ACU', bl_invoices: 'Factures', bl_none_yet: 'Aucune pour l\'instant', pr_custom: 'Sur mesure', pr_free: 'Gratuit', pr_forever: '/à vie', pr_permo: '/mois', pr_current: '✓ Formule actuelle', pr_talk: 'Parlez-nous →', pr_upgrade: 'Passer à', pr_switch: 'Basculer vers', pr_current_badge: 'actuelle', pr_unlimited: 'Illimité', pr_verifications: 'vérifications', pr_prices_note: 'Prix en USD. Les formules payantes sont facturées mensuellement et s\'activent dès que KODA confirme votre paiement mobile money. Les recharges ACU (à l\'usage) se gèrent dans', st_profile: 'Profil de l\'entreprise', st_lang_note: 'L\'OS détecte automatiquement la langue de votre appareil. Remplacer :', st_data: 'Vos données et confidentialité', st_data_p: 'Téléchargez tout ce que KODA détient pour votre entreprise, ou supprimez votre compte.', st_deletion_owner: '(La suppression est réservée au propriétaire.)', st_download: 'Télécharger mes données (JSON)', st_delete: 'Supprimer le compte',
  ...
  en: {
    ...
    sub_verify: 'Door 1 — Manual mode · same engine as the API', sub_disputes: 'KODA assembles the evidence — you decide',
    ...
    dsp_claim: 'Customer claim / reason', dsp_open: 'Open dispute (3 ACU)', dsp_accept: 'Accept', dsp_reject: 'Reject', dsp_escalate: 'Escalate to KODA', dsp_none: 'No disputes — that is the goal.', acc_add: 'Add a receiving account', acc_add_p: 'Enter the operator + the number/till customers pay to. We give you a one-time reference; make a tiny test payment carrying it, and once your Sentinel captures it the account is verified.', acc_connect: 'Connect account', acc_op_ph: 'Operator code (e.g. orange_cd)', acc_op_pick: 'Choose your operator…', th_action: 'Action', acc_verified: 'Ownership verified', acc_on: 'On', acc_off: 'Off', acc_edit: 'Edit', acc_remove: 'Remove', acc_edit_num: 'Receiving number / till:', acc_edit_holder: 'Account holder name:', saved: 'Saved', acc_del_confirm: 'Remove this payment method?', acc_removed: 'Removed', acc_at_checkout: 'Shown at checkout', acc_none_live2: 'Turn a payment method On above to show it to customers.', acc_sentinel_on: 'A KODA Sentinel is online — payments verify automatically and securely (the recommended setup).', acc_sentinel_off: 'Recommended: install the KODA Sentinel app on the phone that receives the money — it reads the real operator SMS and verifies every payment automatically, with automatic fraud protection. No app right now? You can still confirm each payment by pasting the operator SMS you received.', acc_paste_cta: 'Confirm by pasting the SMS', acc_num_ph: 'Your pay-to number / till', acc_holder_ph: 'Account holder name', acc_yours: 'Your accounts', acc_none: 'No accounts yet. Connect one above.', acc_would_see: 'What customers would see now', acc_no_live: 'No live payment methods yet — connect & activate an account (and keep a Sentinel online for auto doors).', th_operator: 'Operator', th_number: 'Number', th_ownership: 'Ownership', th_status: 'Status', th_doors: 'Doors', dev_label_ph: 'Label — e.g. Caisse 2', dev_get_app: 'Get the Sentinel app ↗', dev_none: 'No devices yet.', dev_capture: 'capture', dev_cap_sms: 'SMS (side-load build)', dev_cap_notif: 'Notifications (Play build)', dev_notif_tip: 'Keep operator payment notifications turned ON for this phone — this build verifies from the payment notification, not the SMS. If notifications are off, payments won\'t be captured.', dev_builds_note: 'Sentinel comes in two builds: the side-load app reads the operator SMS; the Google Play app reads the operator payment notification (no SMS permission). Each phone shows its mode below.', tm_name_ph: 'Name', tm_email_ph: 'Email', th_name: 'Name', th_email: 'Email', th_role: 'Role', tm_audit: 'Audit trail', tm_empty: 'Empty', bl_burned: 'ACU burned · 30 days', bl_topup_suffix: 'prepaid via mobile money, verified by KODA itself', bl_voucher_p: 'Bought a KODA voucher from a reseller? Enter the PIN to credit ACU instantly.', bl_distributor: 'Distributor?', bl_distributor_p: 'If KODA has set you up as a distributor (ACU reseller), manage your float and sales here.', bl_see_all: 'See all plans & features →', bl_acu_tx: 'ACU transactions', bl_invoices: 'Invoices', bl_none_yet: 'None yet', pr_custom: 'Custom', pr_free: 'Free', pr_forever: '/forever', pr_permo: '/mo', pr_current: '✓ Current plan', pr_talk: 'Talk to us →', pr_upgrade: 'Upgrade to', pr_switch: 'Switch to', pr_current_badge: 'current', pr_unlimited: 'Unlimited', pr_verifications: 'verifications', pr_prices_note: 'Prices in USD. Paid plans are billed monthly and activate the moment KODA confirms your mobile-money payment. ACU top-ups (pay-as-you-go) are managed in', st_profile: 'Business profile', st_lang_note: 'The OS auto-detects your device language. Override:', st_data: 'Your data & privacy', st_data_p: 'Download everything KODA holds for your business, or delete your account.', st_deletion_owner: '(Deletion is owner-only.)', st_download: 'Download my data (JSON)', st_delete: 'Delete account',
  ...
  sw: { th_action: "Kitendo", acc_verified: "Umiliki umethibitishwa", acc_on: "Imewashwa", acc_off: "Imezimwa", acc_edit: "Hariri", acc_remove: "Ondoa", acc_edit_num: "Nambari/till ya kupokea:", acc_edit_holder: "Jina la mmiliki wa akaunti:", saved: "Imehifadhiwa", acc_del_confirm: "Ondoa njia hii ya malipo?", acc_removed: "Imeondolewa", acc_at_checkout: "Inaonyeshwa wakati wa malipo", acc_none_live2: "Washa njia ya malipo hapo juu ili kuionyesha kwa wateja.", acc_sentinel_on: "Sentinel ya KODA iko mtandaoni — malipo yanathibitishwa kiotomatiki na kwa usalama (mpangilio unaopendekezwa).", acc_sentinel_off: "Inapendekezwa: sakinisha programu ya KODA Sentinel kwenye simu inayopokea pesa — inasoma SMS halisi ya opereta na kuthibitisha kila malipo kiotomatiki, kwa ulinzi wa udanganyifu wa mnyororo-wa-salio. Huna programu sasa? Bado unaweza kuthibitisha kila malipo kwa kubandika SMS ya opereta uliyopokea.", acc_paste_cta: "Thibitisha kwa kubandika SMS", dev_capture: "unasaji", dev_cap_sms: "SMS (toleo la nje ya Play)", dev_cap_notif: "Arifa (toleo la Play)", dev_notif_tip: "Weka arifa za malipo za opereta ZIKIWASHWA kwa simu hii — toleo hili linathibitisha kutoka kwa arifa ya malipo, si SMS. Arifa zikizimwa, malipo hayatanaswa.", dev_builds_note: "Sentinel ina matoleo mawili: programu ya nje ya Play inasoma SMS ya opereta; programu ya Google Play inasoma arifa ya malipo ya opereta (bila ruhusa ya SMS). Kila simu inaonyesha hali yake hapa chini.",
    ...
    sub_verify: 'Mlango 1 — Hali ya mikono · injini ile ile kama API', sub_disputes: 'KODA hukusanya ushahidi — wewe unaamua',
  ...
  ln: { th_action: "Ekela", acc_verified: "Bonkoló endimámí", acc_on: "Efungwámí", acc_off: "Ekangámí", acc_edit: "Bóngola", acc_remove: "Longola", acc_edit_num: "Nimero/kɛ́sɛ ya koyamba:", acc_edit_holder: "Nkómbó ya nkolo kɔ́ntɛ:", saved: "Ebómbámí", acc_del_confirm: "Longola nzelá oyo ya kofuta?", acc_removed: "Elongwámí", acc_at_checkout: "Emonisami na paiement", acc_none_live2: "Pelisa nzelá ya kofuta na likoló mpo baklíya bámóna yango.", acc_sentinel_on: "Sentinel ya KODA ezali na ligne — bapaiement endimámaka yɔ́kɔmɛ́ mpe na libateli (bokɛngɛli oyo tolobelaka).", acc_sentinel_off: "Tolobelaka: tíá app KODA Sentinel na téléphone oyo eyambaka mbongo — etángaka SMS ya sɔ́lɔ ya opérateur mpe endimaka paiement nyɔnsɔ yɔ́kɔmɛ́, na libateli ya lokwámi na nzelá ya chaîne ya solde. Ozali na app tɛ́ sikóyo? Okoki naino kondima paiement mokó mokó na kopéga SMS ya opérateur oyo ozwí.", acc_paste_cta: "Ndima na kopéga SMS", dev_capture: "bokangi", dev_cap_sms: "SMS (version ya libándá ya Play)", dev_cap_notif: "Ba notification (version ya Play)", dev_notif_tip: "Tíká ba notification ya paiement ya opérateur EPELÍSÁMÍ na téléphone oyo — version oyo endimaka na notification ya paiement, SMS tɛ́. Soki ba notification ekufi, bapaiement ekokangama tɛ́.", dev_builds_note: "Sentinel ezali na baversion míbalé: app ya libándá ya Play etángaka SMS ya opérateur; app ya Google Play etángaka notification ya paiement ya opérateur (permission ya SMS tɛ́). Téléphone mokó mokó emonisaka mode na yango awa na nse.", vmeans_t: "Ndimbola ya « endimámí » (mpe óyo ezali tɛ́)", vmeans_y: "Endimámí = SMS ya kondima ya opérateur ekómí na téléphone na yo, kódɛ eyokani (motúya, référence, tángo), esalémí naino tɛ́, mpe elekí na ba contrôle ya lokwámi.", vmeans_n: "Endimisi tɛ́ ete opérateur akoki kozongisa paiement na nsima tɛ́. KODA ebómbaka mbongo na yo tɛ́ — ekɛndɛ mbala moko na kɔ́ntɛ na yo ya mobile money. Mpo na paiement monene tǒ ya kokamwa, salélá « esengeli botáli » liboso ya kopesa biloko.", paste_sms_h: "iPhone tǒ téléphone ezanga Sentinel? Kópya SMS MOBIMBA ya paiement ya opérateur awa. KODA endimaka yango — malamu koleka kódɛ, mpo KODA emónaka SMS ya sɔ́lɔ.",
    ...
    sub_verify: 'Porte 1 — Mode manuel · moteur moko na API', sub_disputes: 'KODA asangisi bilembo — yo nde okokata',
  ...
  wo: { th_action: "Jëf", acc_verified: "Moomeel dëggal na", acc_on: "Dox na", acc_off: "Dawul", acc_edit: "Soppi", acc_remove: "Dindi", acc_edit_num: "Nimero/kes bu ñuy jot:", acc_edit_holder: "Turandoo boroom kont bi:", saved: "Denc na", acc_del_confirm: "Dindi yoonu payement wii?", acc_removed: "Dindi nañu ko", acc_at_checkout: "Wone ci payement", acc_none_live2: "Taxawal yoonu payement ci kaw ngir client yi gis ko.", acc_sentinel_on: "Sentinel bu KODA mu ngi ci ligne — payement yi dañuy dëggal ci saa si te ci kaaraange (jëmm ji ñu digal).", acc_sentinel_off: "Ñu digal: samp app KODA Sentinel ci téléphone bi jotu xaalis — day jàng SMS bu operator bu wóor te dëggal payement bu nekk ci saa si, ak kaaraange fraude ci chaîne bu solde. Amoo app léegi? Man nga dëggal payement bu nekk ci coller SMS bu operator bi nga jot.", acc_paste_cta: "Dëggal ci coller SMS bi", dev_capture: "jàpp", dev_cap_sms: "SMS (version bu dul Play)", dev_cap_notif: "Yégle (version Play)", dev_notif_tip: "Bàyyil yéglee payement yu operator yi ci DOX ci téléphone bii — version bii day dëggal ci yégle bu payement, du SMS. Su yégle yi dee, payement yi duñu leen jàpp.", dev_builds_note: "Sentinel am na ñaari version: app bu dul Play day jàng SMS bu operator; app bu Google Play day jàng yégle bu payement bu operator (amul permission SMS). Téléphone bu nekk day wone anam am ci suuf.", vmeans_t: "Lu « dëggal » tekki (ak lu mu tekkiwul)", vmeans_y: "Dëggal = SMS bu operator bu wóor agsi na sa téléphone, kód bi mengoo na (njëg, référence, jamono), musu ko jëfandikoo, te weesu na kontróol yu fraude.", vmeans_n: "Waaye du wóoral ne operator bi mënul woññi payement bi ci kanam. KODA du yor sa xaalis — mu ngi dem ci sa kont mobile money. Ngir payement bu réy walla bu ëpp, jëfandikool « soxla nañ seetlu » balaa nga jox marchandise.", paste_sms_h: "iPhone walla téléphone bu amul Sentinel? Coppel SMS bu payement bu operator bépp fii. KODA day ko dëggal — gën kód bi, ndaxte KODA day gis SMS bu wóor bi.",
    ...
    sub_verify: 'Buntu 1 — Mode manuel · moteur bu API bi', sub_disputes: 'KODA dafay dajale firnde yi — yaw ngay dogal',
  ...
  ak: { th_action: "Dwumadie", acc_verified: "Wɔasi ahodeɛ so dua", acc_on: "Asɔ", acc_off: "Adum", acc_edit: "Sesa", acc_remove: "Yi firi", acc_edit_num: "Nɔma/till a wɔde gye:", acc_edit_holder: "Akawnt wura din:", saved: "Wɔakora so", acc_del_confirm: "Yi saa akatua kwan yi firi?", acc_removed: "Wɔayi afiri hɔ", acc_at_checkout: "Ɛda adi wɔ akatua berɛ", acc_none_live2: "Sɔ akatua kwan bi wɔ soro hɔ na ama adetɔfoɔ ahunu.", acc_sentinel_on: "KODA Sentinel wɔ intanɛt so — wɔsi akatua so dua ntɛm ara na ahotɔ mu (nhyehyɛeɛ a wɔkamfo).", acc_sentinel_off: "Yɛkamfo sɛ: fa KODA Sentinel app no si fon a ɛgye sika no so — ɛkenkan opereta SMS ankasa na ɛsi akatua biara so dua ntɛm ara, a fraud banbɔ ka ho. Wonni app seesei? Wobɛtumi asi akatua biara so dua bere a wode opereta SMS a wonyaeɛ no bɛtare mu.", acc_paste_cta: "Fa SMS no tare mu fa si so dua", dev_capture: "nsɔ", dev_cap_sms: "SMS (Play-akyi build)", dev_cap_notif: "Amanneɛbɔ (Play build)", dev_notif_tip: "Ma opereta akatua amanneɛbɔ nka HƆ wɔ saa fon yi so — saa build yi si so dua firi akatua amanneɛbɔ no, ɛnyɛ SMS no. Sɛ amanneɛbɔ adum a, wɔrennsɔ akatua no.", dev_builds_note: "Sentinel wɔ build mmienu: Play-akyi app no kenkan opereta SMS; Google Play app no kenkan opereta akatua amanneɛbɔ (SMS kwan nni ho). Fon biara kyerɛ ne tebea wɔ ase hɔ.", vmeans_t: "Deɛ « wɔasi so dua » kyerɛ (ne deɛ ɛnkyerɛ)", vmeans_y: "Wɔasi so dua = opereta ankasa nkraseɛ SMS aduru wo fon so, kɔɔd no ne no hyia (sika dodoɔ, reference, berɛ), wɔmfaa nnii dwuma da, na ɛtwaa fraud nhwehwɛmu no.", vmeans_n: "Ɛnkyerɛ sɛ opereta rentumi nnane akatua no akyire yi. KODA nkora wo sika so — ɛkɔ wo mobile money akawnt mu tee. Sɛ ɛyɛ akatua kɛseɛ anaa deɛ ɛyɛ soronko a, fa « ɛhia nhwehwɛmu » di dwuma ansa na wode nneɛma ama.", paste_sms_h: "iPhone anaa fon a Sentinel nni so? Kopy opereta akatua SMS no NYINAA wɔ ha. KODA si so dua — ɛyɛ kyɛn kɔɔd, ɛfiri sɛ KODA hunu SMS ankasa no.",
    ...
    sub_verify: 'Ɔpon 1 — Nsa so kwan · engine korɔ no ara sɛ API', sub_disputes: 'KODA boaboa adanseɛ ano — wo na wobɛsi gyinae',
...
window.injectSms = async () => {
  try { const r = await api('/app/sandbox/sms', { body: { raw: v('raw'), operator: 'orange_cd' } });
    toast(r.quarantined ? '⚠ SMS quarantined — forgery detected'
...
VIEWS.accounts = async () => {
  ...
  const opName = (code) => (operators.find(o => o.code === code) || {}).name || code;
  const liveAccts = accts.filter(a => a.activation_status === 'ACTIVE');
  const deviceOnline = (devices || []).some(d => d.status === 'active' && d.last_seen &&
    (Date.now() - new Date(String(d.last_seen).replace(' ', 'T') + 'Z').getTime()) < 15 * 60 * 1000);
  window.__naOps = operators;
  window.__naAccts = accts;
  ...
  <div class="card tbl-wrap" style="margin-top:14px"><h3>${t('acc_yours')} (${fmt(accts.length)})</h3>
    ${accts.length ? `<table class="tbl"><tr><th>${t('th_operator')}</th><th>${t('th_number')}</th><th>${t('th_name')}</th><th>${t('th_status')}</th><th style="text-align:right">${t('th_action')}</th></tr>
    ${accts.map(a => { const on = a.activation_status === 'ACTIVE'; return `<tr>
      <td><b>${esc(opName(a.network_code))}</b>${a.ownership_status === 'VERIFIED' ? ` <span class="badge b-ok" style="font-size:9px" title="${t('acc_verified')}">✓</span>` : ''}</td>
      <td class="mono">${esc(a.account_identifier || a.masked || '—')}</td>
  ...
  <div class="card" style="margin-top:14px"><h3>${t('acc_would_see')}</h3>
    ...
    <div style="margin-top:10px;padding:10px 12px;border-radius:8px;background:var(--ink);font-size:12px;border:1px solid var(--line-strong);color:var(--dim);line-height:1.5">
      ${deviceOnline ? '✅ ' + t('acc_sentinel_on') : '⚠️ ' + t('acc_sentinel_off') + ` <a onclick="location.hash='#verify'" style="color:var(--gold);cursor:pointer">${t('acc_paste_cta')}</a> · <a onclick="location.hash='#devices'" style="color:var(--gold);cursor:pointer">${t('dev_get_app')}</a>`}
    </div></div>`);
...
window.toggleAccount = async (id, status) => {
  const on = status === 'ACTIVE';
  try { await api(`/app/network-accounts/${id}/${on ? 'pause' : 'activate'}`, { body: {} }); toast(on ? '✓ ' + t('acc_off') : '✓ ' + t('acc_on')); route(); }
  catch (e) { toast('✗ ' + e.message); }
};
window.editAccount = async (id) => {
  const a = (window.__naAccts || []).find(x => x.id === id); if (!a) return;
  const num = prompt(t('acc_edit_num'), a.account_identifier || '');
  if (num === null) return;
  const holder = prompt(t('acc_edit_holder'), a.account_holder_name || '');
  if (holder === null) return;
  try { await api(`/app/network-accounts/${id}/update`, { body: { account_identifier: num, account_holder_name: holder } }); toast('✓ ' + t('saved')); route(); }
  catch (e) { toast('✗ ' + e.message); }
};
window.deleteAccount = async (id) => {
  if (!confirm(t('acc_del_confirm'))) return;
  try { await api(`/app/network-accounts/${id}/remove`, { body: {} }); toast('✓ ' + t('acc_removed')); route(); }
  catch (e) { toast('✗ ' + e.message); }
};
...
VIEWS.devices = async () => {
  ...
  <p style="font-size:12.5px;color:var(--dim);margin:12px 2px 0;line-height:1.5">${t('dev_builds_note')}</p>
  <div class="grid g2" style="margin-top:10px">
    ${rows.map(d => { const notif = d.capture === 'notification'; return `<div class="card">
      ...
      ${notif ? `<div style="margin-top:10px;font-size:11.5px;color:var(--dim);background:var(--ink);border:1px solid var(--line-strong);border-radius:8px;padding:9px 11px;line-height:1.5">⚠ ${t('dev_notif_tip')}</div>` : ''}
...
const PLAN_FEATURES = {
  ...
  commerce:   ['Everything in Boutique', '5 devices · 10 seats', 'Vision + screenshot forensics', 'Dispute assistant', 'Priority parsing · WhatsApp SLA', 'Overage $0.0325 / extra verification'],
...
function renderGrowth(tool, r) {
  ...
  // "template preview" note so we never pass a template off as AI.
  const aiBlock = (r && r.ai_text)
    ? `<div class="card" style="border-color:var(--gold);background:rgba(232,161,31,.06);margin-bottom:12px">
         <span class="badge b-info" style="margin-bottom:8px;display:inline-block">✦ Generated by KODA AI${r.ai_provider ? ' · ' + esc(r.ai_provider) : ''}</span>
         <div style="white-space:pre-wrap;line-height:1.55;font-size:14px">${esc(r.ai_text)}</div></div>`
    : (r && r.ai_available && r.ai_error
        ? `<div class="badge b-warn" style="display:block;margin-bottom:12px;line-height:1.5;white-space:normal">AI generation failed (<span class="mono">${esc(r.ai_error)}</span>) — showing a template, not charged. If this is a model error, set <span class="mono">KODA_AI_MODEL</span> to a model your key can access, then retry.</div>`
        : (r && r.ai_available === false
            ? `<div class="badge b-warn" style="display:block;margin-bottom:12px;line-height:1.5;white-space:normal">Template preview — add an AI key (ANTHROPIC_API_KEY) on the server for live AI copy. You were not charged.</div>`
            : ''));
  return aiBlock + renderGrowthBody(tool, r);
}
function renderGrowthBody(tool, r) {
