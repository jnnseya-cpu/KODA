...
if (fs.existsSync(landingSrc)) {
  ...
  landing = landing
    ...
    .replace(/<a class="pbtn" href="#">Choose Plateforme<\/a>/, '<a class="pbtn" href="/app#signup?plan=plateforme">Choose Plateforme</a>')
    .replace(/<a class="pbtn" href="#">Choose Scale<\/a>/, '<a class="pbtn" href="/app#signup?plan=scale">Choose Scale</a>')
...
<div class="card" style="border-color:var(--gold);background:linear-gradient(180deg,rgba(232,161,31,.08),transparent)">
  ...
  <p style="margin:16px 0 0;font-size:13px;color:var(--dim)">Sell <b style="color:var(--text)">ACU credit</b> or <b style="color:var(--text)">monthly plans</b> — buy inventory at wholesale (80% reseller · 85% distributor), resell at the list price and keep the <b style="color:var(--text)">15–20% spread</b>. Scale it: a reseller moving <b style="color:var(--text)">$1,000</b> a week keeps <b style="color:var(--text)">$200</b>. (Merchants who can pay KODA directly get the lower direct price; the agent list price is the convenience premium for cash.)</p>
